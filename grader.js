...
var checkHtml = function(html, checksfile, isFile) {
    var $;
    $ = isFile ? cheerioHtmlFile(html) : cheerioHtml(html);
...
var getFileFromUrl = function (url, check_file) {
    if (!url) return false;
    ...
    rest.get(url).on('complete', function (result) {
        if (result instanceof Error) {
           ...
           var checkJson = checkHtml(result, check_file);
